...
switch ($method) {
    case "GET":
        ...
        if (isset($_GET['patient_id'])) {
            ...
            $sql = "SELECT questions.question_text, info_answers.answer_text FROM questions INNER JOIN info_answers ON questions.question_id = info_answers.question_id WHERE info_answers.patient_id = :patient_id";
        }
